    ...
    <div class="card">
        ...
        <div class="card-body">
            <form class="needs-validation" novalidate action="{{ route('category.store') }}" method="POST">
                @csrf
                <div class="form-row">
                    <label class="form-control-label" for="validationNamaCategory">Name</label>
                    <input type="text" name="name" class="form-control" id="validationNamaCategory" placeholder="Category Name" value="" required>
